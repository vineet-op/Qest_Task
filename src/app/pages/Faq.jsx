    ...
    return (
        <div className="w-screen h-[811px] bg-neutral-100 flex justify-center items-center">
            <div className="w-[724px] h-[691px] pt-[60px]">
                ...
                <div className="pt-[48px]">
                    <form class="flex items-center max-w-full mx-auto">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 " placeholder="Ask Q! e.g Tell me about key Features." required />
                        </div>
                ...
                <p className="text-center mt-6">Haven’t got your answer? <span className="text-blue-600 underline"> <a href="/support"> Contact our support now</a></span></p>
            </div>
        </div>
    );
};
